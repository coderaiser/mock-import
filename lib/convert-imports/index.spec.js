...
test.skip('mock-imports: convert imports', async (t) => {
...
test.skip('mock-imports: convert imports: bin', async (t) => {
...
test.skip('mock-imports: convert imports: namespace', async (t) => {
...
test.skip('mock-imports: convert imports: export-from', async (t) => {
...
test.skip('mock-imports: convert imports: reImport', async (t) => {
...
test.skip('mock-imports: convert imports: reImport: no env', async (t) => {
    const from = new URL('./fixture/re-import.js', url);
    const source = await readFile(from, 'utf8');
...
test.skip('mock-imports: convert imports: sourcemap', async (t) => {
